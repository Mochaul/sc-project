...
#  Nov 14, 2018 10:51:10 PM +07  platform: Windows NT
set vTcl(timestamp) ""
...
foreach img {
        ...
        {{[file join C:/ Users tirta Desktop Susi.jpg]} {user image} user {}}
...
proc vTclWindow.top42 {base} {
    ...
    wm deiconify $top
    wm title $top "Tenggelamkan"
    vTcl:DefineAlias "$top" "Toplevel1" vTcl:Toplevel:WidgetProc "" 1
    ttk::label $top.tLa43 \
        -background {#d9d9d9} -foreground {#000000} \
        -font $::vTcl(fonts,vTcl:font9,object) -relief flat \
        -text {TENGGELAMKAN !} \
        -image [vTcl:image:get_image [file join C:/ Users tirta Desktop Susi.jpg]] 
    ...
    ###################
    place $top.tLa43 \
        -in $top -x 0 -y 0 -width 496 -relwidth 0 -height 409 -relheight 0 \
